  ...
  return (
    <div className="container mt-6">
      ...
      <div>
        ...
        <Typography variant="medium">{text} @medium</Typography>
        <Typography variant="small">{text} @small</Typography>
        <Typography variant="lead">{text} @lead</Typography>
        <Typography variant="p">{text} @p</Typography>
        <Typography variant="muted">{text} @muted</Typography>

        <Typography variant="code">{text} @code</Typography>
        <Typography variant="blockquote">{text} @blockquote</Typography>
        ...
        <div className="flex p-5 gap-3">
          <Card.Root>
            ...
            <Card.Content className="grid gap-1 -mb-2">
              {options.map((x) => (
                <div
                  key={x.title}
                ...
                >
                  ...
                  <div className="space-y-1">
                    <Typography variant="small">{x.title}</Typography>
                    <Typography variant="muted">{x.description}</Typography>
                  </div>
                </div>
              ))}
            </Card.Content>
